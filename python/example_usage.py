...
with SwimFile(path, "w") as f:
    f.set_metadata(
        athlete_name="Jane Doe", event="100m Freestyle", distance_m=100,
        stroke="freestyle", course="LCM", date="2026-09-18",
...
print("Event:", data["metadata"]["event"], "| Result:", data["metadata"]["result_time_s"], "s")
